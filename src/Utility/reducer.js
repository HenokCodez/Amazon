  ...
  switch (action.type) {
    case Type.ADD_TO_BASKET: {
      ...
      if (!existingItem) {
        ...
        // item comes from .find() and .map(), representing elements in the basket array.
        // setItem is not a variable but a method of localStorage used to store data.
    ...
    case Type.REMOVE_FROM_BASKET: {
      ...
      if (index >= 0) {
        if (newBasket[index].amount > 1) {
          ...
          // splice() method in JavaScript is used to add, remove, or replace elements in an array. It modifies the original array and returns the removed elements (if any).
          // let fruits = ["Apple", "Banana", "Mango", "Orange"];
          // fruits.splice(1, 2); // Removes "Banana" and "Mango"
